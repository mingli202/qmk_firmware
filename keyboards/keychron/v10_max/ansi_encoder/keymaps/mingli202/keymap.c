...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_89(
        ...
        MC_5,       FN,       KC_LOPTN,           KC_LCMMD, L1,       KC_CAPS,                       KC_SPC,             KC_RCMMD,                     KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [MAC_LAYER_1] = LAYOUT_ansi_89(
        _______,    _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,    _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,    _______,  _______,  _______,  L_PRTS,   R_PRTS,   _______,   _______,  _______,  _______,  KC_BSPC,  _______,  _______,  _______,  _______,            _______,
        _______,    _______,  L_CBRC  ,  R_CBRC,  L_BRC,    R_BRC,    _______,   KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  _______,  _______,            _______,            _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [MAC_LAYER_1] = {ENCODER_CCW_CW(RGB_VAD, RGB_VAI)},
