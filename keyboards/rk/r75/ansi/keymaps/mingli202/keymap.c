...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT( /* FN */
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  RM_PREV,  RM_NEXT,  RM_TOGG,  KC_PAUSE,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  RM_SATD,  RM_SATU,            _______,  KC_END,
        MO(2),    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  RM_HUED,  RM_HUEU,            RM_VALU,
